...
<head>
  ...
  <title>@yield('title') - Si kaleng Infaq</title>
  ...
  <div id="wrapper">
   ...
   <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
      ...
      <div class="sidebar-brand-text mx-3"></i>SI Kaleng Infaq</div>
    </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse3" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <span>Penyaluran Infaq</span>
        </a>
        <div id="collapse3" class="collapse  " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Penyaluran Infaq</h6>
                <a class="collapse-item" href="{{route('penyaluran.create')}}">Input</a>
            </div>
        </div>
    </li>
    @endif
    ...
    <li class="nav-item">
     <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse4" aria-expanded="true" aria-controls="collapseTwo">
       ...
       <span>Penerimaan Infaq</span>
     </a>
     <div id="collapse4" class="collapse  " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
       <div class="bg-white py-2 collapse-inner rounded">
         <h6 class="collapse-header">Penerimaan Infaq</h6>
         <a class="collapse-item  " href="{{route('penerimaan.create')}}">Input</a>
         @if (Auth::user()->level == '0')
         <a class="collapse-item " href="{{route('penerimaan.index')}}">Data Penerimaan</a>
         @endif
       </div>
     </div>
   </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapse5" class="collapse     " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{route('penerimaan.laporan')}}">Penerimaan Infaq</a>
          <a class="collapse-item" href="{{route('penyaluran.index')}}">Penyaluran Infaq</a>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Anda akan mengakhiri session ini</div>
